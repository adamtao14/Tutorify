  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="materie.php" class="list-group-item list-group-item-action bg-dark" style="color: white;">Materie</a>
  ...
  foreach ($rows as $r) {
    ...
    $html .= "
       <tr><form action='../../php/update.php' method='post'>
        ...
        <td><input type='text' name='descrizione_a' value='{$r['descrizione']}' style='width:100%;''; </td>
        <td><input type='submit' name='elimina_M_a' value='Elimina'> </td>
