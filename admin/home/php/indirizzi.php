...
$sql = "select * from indirizzi_scolastici ";
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="indirizzi.php" class="list-group-item list-group-item-action bg-dark" style="color: white;">Indirizzi</a>
  ...
  foreach ($rows as $r) {
    ...
    $html .= "
       <tr><form action='../../php/update.php' method='post'>
        ...
        <td><input type='text' name='nome_indirizzo_a' value='{$r['nome_indirizzo']}' style='width:100%;''; </td>
        <td><input type='submit' name='elimina_I_a' value='Elimina'> </td>
        <td><input type='submit' value='Modifica_a'></td>
        </form></tr>
    ";
  }
